...
export const accordionItems2 = [
  {
    ...
    content:
      "Modern APIs use robust security protocols like OAuth, API keys, and encryption to safeguard data and control access.",
    isOpen: false,
  },
  {
    id: 25,
    ...
    content:
      "Instant data transfer allows applications to update dynamically, ensuring users always have the latest information.",
    isOpen: false,
  },
  {
    id: 27,
    ...
    content:
      "APIs typically follow REST, SOAP, or GraphQL standards, ensuring compatibility and ease of use across platforms.",
    isOpen: true,
  },
];
